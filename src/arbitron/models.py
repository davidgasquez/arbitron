...
class ComparisonResult(BaseModel):
    ...
    agent_id: str = Field(..., description="Identifier of the agent making the decision")
...
class RankingResult(BaseModel):
    ...
    scores: Dict[str, float] = Field(..., description="Bradley-Terry scores for each item")
    comparisons: List[ComparisonResult] = Field(..., description="All pairwise comparisons made")
